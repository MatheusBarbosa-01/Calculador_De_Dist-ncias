...
def main():
    ...
    def bidimensional():
        ...
        distanciaRounded = round(distanciaResult, 2)
        print('\nA distância entre os pontos A e B no plano 2D é:', distanciaRounded)
    ...
    def tridimensional():
        ...
        distanciaRounded = round(distanciaResult, 2)
        print('\nA distância entre os pontos A e B no espaço 3D é:', distanciaRounded)
        print('Aperte qualquer tecla para retornar ao menu: ')
        key = read_key()
        os.system('cls')
        print('Retornando...')
